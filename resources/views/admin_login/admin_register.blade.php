...
@section('body')
    ...
    <div class="sign-up-form">
        ...
        <div class="sign-up">
            ...
            <div class="col-md-6 login-right col-lg-offset-6">
                <h3 class="tittle">Login Here <i class="glyphicon glyphicon-file"></i></h3>
                <a href="{{route('admin_login')}}" class="hvr-bounce-to-bottom button">Login if registered</a>
            </div>
        </div>
    </div>
